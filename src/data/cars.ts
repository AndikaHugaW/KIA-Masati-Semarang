...
export const CARS_DATA: Car[] = [
  ...
  },
  {
    ...
    description: 'KIA All-New Seltos 2026 Crossover SUV modern dengan performa mesin turbo yang responsif, fitur hiburan canggih, dan sistem navigasi cerdas untuk mobilitas perkotaan.',
    kilometer: '0 km',
    status: 'Tersedia',
  ...
  },
  {
    ...
    description: 'KIA Carnival 2026 MPV mewah keluarga dengan konfigurasi tempat duduk 7-seater yang sangat nyaman, teknologi terdepan, serta pilihan mesin Premiere (Diesel) dan Hybrid untuk perjalanan jarak jauh.',
    kilometer: '0 km',
    status: 'Tersedia',
  ...
  },
  {
    ...
    description: 'KIA EV9 2026 SUV listrik futuristik 6-Seater premium dengan performa bertenaga, kabin mewah dan ruang yang sangat lapang. Dilengkapi fitur keselamatan otonom tingkat tinggi.',
    kilometer: '0 km',
    status: 'Tersedia',
