  ...
  return (
    <section className="bg-white py-14 sm:py-20 md:py-24 px-4 sm:px-8 lg:px-12 border-b border-gray-100">
      <div className="max-w-4xl mx-auto text-left space-y-6 sm:space-y-8">
        <p className="text-gray-800 text-lg sm:text-xl md:text-2xl font-medium leading-relaxed sm:leading-loose">
        ...
        <p className="text-gray-600 text-lg sm:text-xl md:text-2xl font-medium leading-relaxed sm:leading-loose">
