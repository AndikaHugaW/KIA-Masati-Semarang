...
export const HeroSection: React.FC<HeroSectionProps> = ({ onOpenTestDrive }) => {
  ...
  return (
    <section className="relative w-full min-h-[92dvh] lg:min-h-screen flex flex-col justify-end overflow-hidden bg-neutral-950 text-white p-6 sm:p-10 lg:p-14 rounded-none my-0 z-20">
      ...
      {/* 2. Floating Glass Menu Card (Right Side on Desktop & Tablet) */}
      <div className="absolute top-1/2 -translate-y-1/2 right-6 sm:right-10 lg:right-14 z-20 hidden sm:flex">
      ...
      {/* 3. Bottom-Left Hero Headline & Action Pill Buttons */}
